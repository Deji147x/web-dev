        ...
        <main className="min-h-screen bg-background">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row gap-12 items-center">
                    <div className="lg:w-1/2">
                        <h1 className="text-4xl md:text-5xl font-bold text-primary dark:text-white mb-6">
                            Sell Your House Fast <span className="text-secondary">Maryland</span>
                        </h1>
                        <p className="text-lg text-slate-600 dark:text-slate-300 mb-8 leading-relaxed">
                            Count on Parlevu Global Services LLC to buy your house fast in Maryland. We buy houses in “as-is” condition. No repairs. No inspections. No commissions/fees.
                        </p>
                    ...
                    <div className="lg:w-1/2 w-full">
                        <LeadForm title="Semm My House Fast Maryland" />
                    </div>
                </div>
            </div>
            ...
            <div className="py-20 bg-white dark:bg-black">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-lg dark:prose-invert">
                    <h2>We Buy Houses Maryland</h2>
                    <p>Worried that a unique situation has come up and you’re not sure if you’ll be able to sell your house fast for cash? We’re experienced in many different circumstances that may arise in when needing to sell a house fast for cash.</p>
                    <p>We buy houses, townhomes, rowhomes and condos for cash in Maryland regardless of the reason you want to sell.</p>

                    <h3>Cash Home Buyers Maryland</h3>
                    <p>As a local cash buyer in Maryland, our purpose is to help you sell your house fast for cash as quick and painless as possible.</p>
                    <p>By calling us for a 100% no-obligation, cash offer on your Maryland house, you can skip all of those headaches, sell your house and have the money in your pocket in as little as 7-14 days…without expensive commissions and fees.</p>
                </div>
            </div>
